...
//            'Rpasswords' => 'password',
     ...
     * @return array
     */
    public static function getResPromotionStart()
    {
        $resStartDate = Respromotion::find()->asArray()->all();
        return ArrayHelper::map($resStartDate, 'ResPromotionStart', 'ResPromotionStart');
    }

    /**
     * @return array
     */
    public static function getResPromotionEnd()
    {
        $resPromotionEnd = Respromotion::find()->asArray()->all();
        return ArrayHelper::map($resPromotionEnd, 'ResPromotionEnd', 'ResPromotionEnd');
    }
