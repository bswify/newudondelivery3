...
use backend\models\ShowrepsromotiontSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ShowrespromotiontController implements the CRUD actions for Respromotion model.
 */
class ShowrespromotiontController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new ShowrepsromotiontSearch();
