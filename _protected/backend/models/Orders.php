...
class Orders extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['OrderDate', 'OrderTotalPrice', 'OrderStatus', 'IDPaymant', 'IDCustomer','IDCustomerAddress',], 'required'],
            [['OrderDate'], 'safe'],
    ...
    public function scenarios(){
        ...
        $scenarios['create'] = ['OrderDate','OrderNote','OrderTotalPrice','OrderStatus','IDPaymant','IDCustomer','Orderpayprice','IDCustomerAddress'];
        return $scenarios;
    }
